// Stylography seed data — used as fallback / demo data
...
export const STYLE_CLUSTERS = [
  ...
  { id: 'gorpcore',       name: 'Gorpcore',         color: '#6B8F71', desc: 'technical gear, fleece, trail-ready' },
  { id: 'dark-academia',  name: 'Dark Academia',    color: '#4A3728', desc: 'tweed, plaid, library aesthetic' },
  { id: 'boho',           name: 'Boho',             color: '#C9956A', desc: 'fringe, earth tones, flowy' },
  { id: 'coastal',        name: 'Coastal Granddaughter', color: '#7FA8B8', desc: 'linen, stripes, breezy layers' },
  { id: 'indie',          name: 'Indie / Folk',     color: '#8B7355', desc: 'band tees, thrifted, worn-in' },
  { id: 'old-money',      name: 'Old Money',        color: '#8C9E8C', desc: 'cashmere, tailored, quiet luxury' },
];
