...
const TOUR_STEPS = [
  {
    ...
    speech:
      "Hey there! I'm Stitchy, your Stylography guide. Let me show you around your new dashboard. It'll only take a minute, and you can skip ahead anytime.",
    pointer: null,
  },
  {
    id: "sidebar",
    ...
    title: "Navigation",
    speech:
      "This is your sidebar. From here you can jump to your inventory, upload new items, manage claims, create outfit boards, and view your store profile. Everything you need is one click away.",
    pointer: "left",
  },
  {
    id: "kpis",
    ...
    speech:
      "These cards show your key numbers at a glance. Item views, saves, store visits, active claims, revenue, and your store balance. They update in real time as shoppers engage with your items.",
    pointer: "down",
  },
  {
    id: "attention-chart",
    ...
    speech:
      "This chart tracks how many shoppers are viewing and saving your items each day. It's the best way to see if your uploads are getting traction.",
    pointer: "down",
  },
  {
    id: "style-demand",
    ...
    title: "Style demand",
    speech:
      "Style cluster demand shows you what aesthetics your shoppers love most. If Y2K is trending, that's a signal to source more pieces in that style.",
    pointer: "down",
  },
  {
    id: "top-saved",
    ...
    speech:
      "Saves are the strongest signal of purchase intent. If something has lots of saves but no claims, consider adjusting the price.",
    pointer: "down",
  },
  {
    id: "claims",
    ...
    speech:
      "When a shopper reserves one of your items, it shows up here. Try to respond within two hours for the best experience.",
    pointer: "down",
  },
  {
    id: "upload-cta",
    ...
    speech:
      "That's the tour! Your next step is uploading your first items. Click Upload Items, drop some photos, and our AI will auto-tag everything. You've got this!",
    pointer: "right",
  },
];
...
async function askStitchy(messages) {
  ...
  const model = genAI.getGenerativeModel({
    ...
    systemInstruction: STITCHY_SYSTEM,
  });
...
const MascotSVG = ({ speaking, size = 52 }) => (
  ...
  >
    ...
    <path
      d="M50 36 Q56 28 52 20 Q48 14 54 10"
      stroke="#D4A5A5"
      strokeWidth="1.5"
      fill="none"
      strokeLinecap="round"
...
const Pointer = ({ direction }) => {
  const s = {
    down: {
      ...
      borderTopColor: "var(--aubergine-600)",
    },
    left: {
      left: -10,
      top: "50%",
      ...
      border: "8px solid transparent",
      borderRightColor: "var(--aubergine-600)",
    },
    right: {
      right: -10,
      top: "50%",
      transform: "translateY(-50%)",
      border: "8px solid transparent",
      borderLeftColor: "var(--aubergine-600)",
    },
  };
  return (
    <div
      style={{ position: "absolute", width: 0, height: 0, ...s[direction] }}
    />
  );
};
...
export default function DashboardGuide({ userId, onDismiss }) {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      text: "Tour's done! 🧵 I'm still here if you have questions about your dashboard, uploading items, claims, or anything else. Just type away!",
    },
  ]);
  ...
  useEffect(() => {
    ...
    el.style.zIndex = "60";
    el.style.boxShadow =
      "0 0 0 4px var(--aubergine-600), 0 0 24px rgba(91,77,122,0.3)";
  ...
  const sendQuestion = useCallback(
    async (text) => {
      ...
      try {
        ...
        setChatError(
          err.message ||
            "Could not reach Stitchy. Check your connection and API key.",
        );
      } finally {
        setSpeaking(false);
  ...
  const startListening = useCallback(() => {
    ...
    if (!SR) {
      setChatError(
        "Voice input works best in Chrome, Edge, or Safari. You can type your question below.",
      );
      return;
    }
    stopSpeech();
  ...
  const endCtrlPushToTalk = useCallback(() => {
    if (!ctrlPttHeldRef.current || voiceInputModeRef.current !== "ctrl-ptt")
      return;
    try {
      recognizerRef.current?.stop();
    } catch {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          text: "Hmm, I couldn't process that. Try asking again!",
        },
      ]);
    } finally {
      setThinking(false);
    ...
    return (
      <>
        ...
        >
          ...
          >
            Want a conversational walkthrough of your dashboard, or prefer to
            read it yourself?
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <button
              type="button"
              onClick={() =>
                setPrefs({ narration: false, conversation: false })
              }
              style={{
                textAlign: "left",
                padding: "14px 16px",
            ...
            >
              ...
              >
                I&apos;ll read each step aloud (listen-only)
              </span>
            </button>
            <button
              type="button"
            ...
            >
              ...
              >
                Voice + ask me questions by mic or typing on each step
              </span>
            </button>
          </div>
          <button
      ...
      <>
        ...
        >
          ...
          >
            ...
            <button onClick={dismiss} style={hdrBtn} title="Close">
              ✕
            </button>
          </div>
          ...
          >
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                stroke={input.trim() ? "#fff" : "var(--ink-400)"}
                strokeWidth="2.5"
                strokeLinecap="round"
      ...
      >
              ...
              {!chatReady ? (
                ...
                <>
                  {userLine && (
                    ...
                    >
                      <strong style={{ color: "var(--ink-900)" }}>You:</strong>{" "}
                      {userLine}
                    </div>
                  )}
                  {stitchyLine && (
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: listening
                          ...
                          : "var(--surface)",
                        color: "var(--ink-900)",
                        cursor: chatLoading || listening ? "wait" : "pointer",
                      }}
                    >
                      {listening
                        ? ctrlPttUi
                  ...
                  >
                    <strong style={{ color: "var(--ink-600)" }}>
                      Push-to-talk:
                    </strong>{" "}
                    hold{" "}
                    <kbd
                    ...
                    {!speechRecognitionSupported() &&
                      " Voice isn't available in this browser; use the text box."}
                  </div>
                </>
              )}
            </div>
        ...
        <div
          style={{
            ...
            marginTop: -4,
            animation: speaking
              ? "bounce-mascot 0.6s ease-in-out infinite"
              : "float-mascot 3s ease-in-out infinite",
          }}
        >
